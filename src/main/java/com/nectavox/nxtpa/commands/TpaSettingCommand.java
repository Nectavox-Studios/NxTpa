...
import com.nectavox.nxtpa.guis.SettingGUI;
...
@Command(name = "nxtpasetting")
@HasPermission(Perms.SETTING_USE)
@PlayerOnly
public class TpaSettingCommand extends CommandBase {
    ...
    public void execute(CommandSender sender, String[] args) {
        SettingGUI.open((Player) sender, plugin);
    }
